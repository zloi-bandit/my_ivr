...
INSERT INTO `actions_table` VALUES (1,'play_announcement','background',1),(2,'terminate_call','terminate',1),(3,'play_and_ignore_input','playback',1),(6,'go_to_another_menu','goto_ivr',0),(7,'change_tariff','change_tariff',0),(8,'call_back','call_back',0),(9,'check_balance','say_balance',0);
...
INSERT INTO `audiofiles_table` VALUES (1,'added.alaw','ru','alaw'),(2,'beep.alaw','ru','alaw'),(3,'activated.alaw','en','alaw'),(4,'agent-pass.alaw','en','alaw'),(5,'receiving.alaw','kz','alaw'),(6,'registrar.alaw','kz','alaw');
...
INSERT INTO `ivr_actions` VALUES ('1',1,5,'10',''),('1_1',1,6,'',''),('1_2',1,7,'',''),('1_3',1,8,'','');
...
INSERT INTO `ivr_names` VALUES ('1','Test IVR'),('1-1','Test IVR 1-1');
...
INSERT INTO `language_en` VALUES ('call_back','Callback'),('change_tariff','Change tariff'),('check_balance','Check balance'),('go_to_another_menu','Go to menu'),('play_and_ignore_input','Sound message with no input wait'),('play_announcement','Sound message with input wait'),('terminate_call','Terminate call');
...
INSERT INTO `language_kz` VALUES ('call_back','Кері қоңырау'),('change_tariff','Тарифті ауыстыру'),('check_balance','Балансты тексеру'),('go_to_another_menu','Басқа мәзірге өту'),('play_and_ignore_input','Нөмірді енгізусіз дауыс хабарлама'),('play_announcement','Нөмірді енгізумен дауыс хабарлама'),('terminate_call','Қоңырауын аяқталу');
...
INSERT INTO `language_ru` VALUES ('call_back','Обратный вызов'),('change_tariff','Смена тарифа'),('check_balance','Проверка баланса'),('go_to_another_menu','Переход в меню'),('play_and_ignore_input','Сообщение без ожидания ввода цифр'),('play_announcement','Сообщение с ожиданием ввода цифр'),('terminate_call','Завершение вызова');
...
-- Dump completed on 2017-09-22 17:34:13
